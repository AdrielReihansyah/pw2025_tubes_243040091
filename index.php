        ...
        <div class="services-grid">
            <div class="service-card">
                <div class="service-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h12A2.25 2.25 0 0 0 20.25 14.25V3m-15.75 0h15.75M3.75 3v1.5m15.75-1.5v1.5m-15.75 6.75h15.75m-15.75 3h15.75M3.75 12h15.75m-15.75 0a2.25 2.25 0 0 1-2.25-2.25V6.75A2.25 2.25 0 0 1 3.75 4.5h1.5a2.25 2.25 0 0 1 2.25 2.25v1.5A2.25 2.25 0 0 1 3.75 12Zm15-7.5a2.25 2.25 0 0 1-2.25-2.25V4.5A2.25 2.25 0 0 1 18.75 2.25h1.5a2.25 2.25 0 0 1 2.25 2.25v1.5a2.25 2.25 0 0 1-2.25 2.25h-1.5Zm-6 13.5a1.5 1.5 0 1 1 3 0 1.5 1.5 0 0 1-3 0Z" /></svg>
                </div>
                <h3>Poli Umum</h3>
            ...
            <div class="service-card">
                <div class="service-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M11.25 4.5l7.5 7.5-7.5 7.5m-6-15l7.5 7.5-7.5 7.5" /></svg> </div>
        ...
        <div class="doctor-grid">
            ...
            try {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo '      <img src="https://via.placeholder.com/300x300.png/007BFF/FFFFFF?text=' . substr($row['nama_dokter'], 0, 1) . '" alt="Foto ' . htmlspecialchars($row['nama_dokter']) . '">';
                    echo '  </div>';
        ...
        <div class="contact-wrapper">
            <div class="contact-info">
                ...
                <div class="info-item">
                    ...
                    <div class="info-text">
                        <h4>Alamat</h4>
                        <p>Jalan Kesehatan No. 123, Jakarta Pusat, 10110</p>
                    </div>
                </div>
                ...
                <div class="contact-map">
                    <img src="https://i.ibb.co/L85dKQr/Screenshot-2024-03-22-at-15-01-16.png" alt="Peta Lokasi Klinik">
                </div>
            </div>
