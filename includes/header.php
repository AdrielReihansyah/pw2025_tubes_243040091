    ...
    <header class="site-header">
        <nav class="navbar">
            <div class="navbar-container">
                <a href="/klinik-website/index.php#home" class="nav-logo">
                    Klinik Sehat
                </a>
                ...
                <div class="nav-auth">
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <a href="/klinik-website/auth/logout.php" class="nav-icon-btn" title="Logout">
                    ...
                    <?php else: ?>
                        <a href="/klinik-website/auth/login.php" class="nav-link login-link">Login</a>
                        <a href="/klinik-website/auth/register.php" class="btn btn-primary nav-cta">Daftar</a>
                    <?php endif; ?>
                </div>
            </div>
        </nav>
